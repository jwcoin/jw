...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("JohnnieWalkerCoin-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("JohnnieWalkerCoin-net");
...
static const char *strDNSSeed[][2] = {
    {"198.199.90.93", "198.199.90.93"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("JohnnieWalkerCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("JohnnieWalkerCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("JohnnieWalkerCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("JohnnieWalkerCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. JohnnieWalkerCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("JohnnieWalkerCoin-start");
