...
int64_t nTargetSpacing = 3 * 60;  // Same as the above
...
const string strMessageMagic = "JohnnieWalkerCoin Signed Message:\n";
...
{
    int64_t nSubsidy = 777 * COIN;
	
	if (nHeight == 1)
		return 190000000*COIN;
...
static const int64_t nTargetTimespan = 3 * 15 * 60;
...
void ThreadScriptCheck(void*) {
    ...
    RenameThread("JohnnieWalkerCoin-scriptch");
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in JohnnieWalkerCoin
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (fProofOfStake)
    {
        ...
        // JohnnieWalkerCoin: check proof-of-stake block signature
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "JohnnieWalkerCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "JCW Genesis";
        CTransaction txNew;
        txNew.nTime = 1470009200;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1470009217;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1694697; // !fTestNet ? 1575379 : 46534;
...
unsigned char pchMessageStart[4] = { 0xbb, 0xa8, 0xe1, 0xe5 };
