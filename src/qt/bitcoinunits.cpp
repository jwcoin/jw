...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("JW");
    case mBTC: return QString("mJW");
    case uBTC: return QString::fromUtf8("μJW");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("JohnnieWalkerCoins"));
    case mBTC: return QString(QObject::tr("Milli-JohnnieWalkerCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-JohnnieWalkerCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
